...
DEFAULT_SETTINGS = {
    ...
    "claude_autopilot_enabled": DEFAULTS.claude_autopilot_enabled,
    "claude_autopilot_model": DEFAULTS.claude_autopilot_model,
    "claude_autopilot_schedule": DEFAULTS.claude_autopilot_schedule,
    "claude_autopilot_cycle_enabled": DEFAULTS.claude_autopilot_cycle_enabled,
    "claude_max_tokens": DEFAULTS.claude_max_tokens,
    "claude_temperature": DEFAULTS.claude_temperature,
    "claude_autopilot_last_run_ts": 0.0,
